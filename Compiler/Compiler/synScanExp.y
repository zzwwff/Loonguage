...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <expressions> semicolon_expression_list
    %type <expressions> comma_expression_list
    %type <case_> case
    %type <cases> case_list
    %type <expression> half_let
    ...
    */
    ...
    { $$ = let($2, $4, $6, $8); }
    |
    ',' OBJECTID ':' TYPEID half_let
    { $$ = let($2, $4, no_expr(), $5); }
    |
    ',' OBJECTID ':' TYPEID ASSIGN expression half_let
    { $$ = let($2, $4, $6, $7); }
    ;
    ...
    $$ = dispatch(object(idtable.lookup_string("self")), $1, $3); }
    |
    OBJECTID '(' ')'
    {  idtable.add_string("self");
    $$ = dispatch(object(idtable.lookup_string("self")), $1, nil_Expressions()); }  
    |
    ...
    { $$ = let($2, $4, $6, $8); }
    |
    LET OBJECTID ':' TYPEID half_let
    { $$ = let($2, $4, no_expr(), $5); }
    |
    LET OBJECTID ':' TYPEID ASSIGN expression half_let
    { $$ = let($2, $4, $6, $7); }
    |
    ...
    |
    semicolon_expression_list error ';'
    { }
    |
    error ';'
    { }
